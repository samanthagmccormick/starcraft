$(document).on('ready', function() {
	...
	// Create a new array for your matched keys + values
	var player = [];

	for (var i in obj.data) {
		var newObject = ({ username: obj.data[i][0], fullname: obj.data[i][1], region: obj.data[i][2], race: obj.data[i][3], wins: obj.data[i][4], losses: obj.data[i][5]});
	...
	table.append("<tr><th id = 'username'>Username</th><th id= 'fullname'>Full Name</th><th id = 'region'>Region</th><th id='race'>Race</th><th id='wins'>Wins</th><th id= 'losses'>Losses</th></tr>");
